...
apigClientFactory.newClient = function (config) {
    ...
    var endpoint = 'https://ef0dps4754.execute-api.us-west-2.amazonaws.com/development';
    ...
    apigClient.changePost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var changePostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/change').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
        ...
        return apiGatewayClient.makeRequest(changePostRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.resetPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var resetPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/reset').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(resetPostRequest, authType, additionalParams, config.apiKey);
    };
