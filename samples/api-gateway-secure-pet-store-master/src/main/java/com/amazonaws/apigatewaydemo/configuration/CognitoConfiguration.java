...
public class CognitoConfiguration {
    ...
    public static final String IDENTITY_POOL_ID = "us-east-1:66ffab96-c1b4-475a-8270-7cadb553637c";
    // TODO: Specify the custom provider name used by the identity pool
    public static final String CUSTOM_PROVIDER_NAME = "login.dorkforces.myapp";
